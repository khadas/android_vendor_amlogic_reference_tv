...
public interface TvControlCommand {
    ...
    int SET_EYE_PROTECTION_MODE = 230;
    int GET_EYE_PROTECTION_MODE = 231;
    int SET_GAMMA = 232;
    ...
    int USB_AUDIO_OUTPUT_MODULE_ENABLE =394;
    int GET_USB_AUDIO_DOUBLE_OUTPUT_MODULE_ENABLE =395;
    int GET_USB_AUDIO_OUTPUT_MODULE_ENABLE =396;
    ...
    int SIGNAL_DETECT_CALLBACK = 502;
