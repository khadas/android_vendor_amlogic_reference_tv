...
public class DroidLogicTvUtils
{
   ...
   public static final int NORATING_UNLOCK_CURRENT = 2;
    ...
    public static final String TV_KEY_SUB_DEFAULT_LANGUAGE = "dtv_sub_first_language";
    public static final String TV_KEY_SUB_SECOND_LANGUAGE = "dtv_sub_second_language";
    ...
    public static String US_ContentRatingDimensions[][] =
        {
            {"", "US_TV_NR", "US_TV_G", "US_TV_PG", "US_TV_14", "US_TV_MA"},
            {"", "US_TV_D"},
            {"", "US_TV_L"},
            {"", "US_TV_S"},
            {"", "US_TV_V"},
            {"", "US_TV_Y", "US_TV_Y7"},
            {"", "US_TV_FV"},
            {"", "US_MV_NR", "US_MV_G", "US_MV_PG", "US_MV_PG13", "US_MV_R", "US_MV_NC17", "US_MV_X", "US_MV_NR"}
        };
